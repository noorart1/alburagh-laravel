...
namespace App\Filament\Resources\Qurans\Schemas;
                ...
                Section::make(__('admin.files_and_images'))
                    ->schema([
                        ...
                        FileUpload::make('file_path')
                            ->label(__('admin.quran_file'))
                            ->disk('drupal')
                            ->directory('quran/files')
                            ->preserveFilenames()
                            ->downloadable()
                            ->openable()
                            ->deletable()
